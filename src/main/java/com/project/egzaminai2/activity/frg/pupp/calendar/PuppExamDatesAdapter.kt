...
class PuppExamDatesAdapter(private val dates: List<MaturityExamDate>):
    RecyclerView.Adapter<PuppExamDatesViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = PuppExamDatesViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.card_view, parent, false)
    )

    @SuppressLint("SetTextI18n")
    override fun onBindViewHolder(holder: PuppExamDatesViewHolder, position: Int) {
