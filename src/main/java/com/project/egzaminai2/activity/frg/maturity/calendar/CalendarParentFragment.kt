...
class CalendarParentFragment: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        childFragmentManager
            .beginTransaction()
            .add(R.id.My_Container_1_ID, CalendarFragment(), "Frag_Middle_tag")
            .commit()
        return layout
    }
    ...
    private fun initCalendar(): CaldroidSampleCustomFragment {
        ...
        ViewModelProvider(this).get(DatesParentViewModel::class.java)
                ...
                val listener: CaldroidListener = object: CaldroidListener() {
                    override fun onSelectDate(date: Date, view: View) {
                        ...
                        val alertDialogBuilder =
                            AlertDialog.Builder(this@CalendarParentFragment.context!!)
                        ...
                        for (i in 0 until dates.size) {
                            ...
                            val examType = dates[i].type.toString()
                    ...
                    override fun onChangeMonth(month: Int, year: Int) {
                        if (month == 5 && year == 2020) {
                            ...
                            val clFrg: Fragment = CalendarFragment()
                            val bundle = Bundle()
