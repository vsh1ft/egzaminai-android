...
/**
 * Created by D1sturbance on 9/12/2016.
 */
public class AppRater {
    ...
    private static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        Button b1 = (Button) dialog.findViewById(R.id.RateButton);
        ...
        Button b2 = (Button) dialog.findViewById(R.id.RemindMeLater);
        ...
        Button b3 = (Button) dialog.findViewById(R.id.NoThanks);
